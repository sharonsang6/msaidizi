...
<div class="container" style="text-align: center;margin-top:15%;margin-bottom:15%;">
			<div>
	...
	<div class="inner-wrapper" style="margin-top: 20px">
   	...
   	<p>Make your profile look appealing to attract employers. Edit your profile after successfully logging in to the portal</p>
   	<center><a href="#" class="btn call-btn">Click here</a></center>
   </div>

</div>
<div class="container" id="aboutus" style="text-align: center;margin-top:15%;margin-bottom:15%;">
<div class="">
            ...
            foreach ($comment as $c) { ?>
	            <div class="h5 font-weight-normal one-slide ">
	              <div class="testimonial w-100 px-3 text-center d-flex flex-direction-column justify-content-center flex-wrap align-items-center">
	                <div class="message text-center blockquote w-100">"<?php echo $c->comment; ?>"</div>
