...
<main>
            <div class="row employersliderrow" style="width: 100%;margin-left: 0px;margin-right: 0px;">
                    ...
                    <div class="col-md-6">
                            <div class="card employercard ">
                                    ...
                                    <div class="card-body employercardbody">
                                       <a href="jobs.php" class="employershortlinks">Services</a><br>
                                       <hr>
                                       <a href="workers.php" class="employershortlinks">Rate workers</a><br>
                                       <hr>
                                       <a href="workers.php" class="employershortlinks">Find workers</a><br>
                                       <hr>
   ...
   <div class="container" style="height: 400px;">
	...
	<div class="inner-wrapper" style="margin-top: 20px">
   	<h3 class="call-action-title">Get your dream worker today </h3>
   	<p>Find a worker anywhere anytime. Check the location of leave-out workers before contacting them.</p>
   	<?php if($user->is_loggedin()=="") { ?>
      <center><a href="login.php" class="btn call-btn">Login to find worker</a></center>
    <?php }else{ ?>
      <center><a href="jobs.php" class="btn call-btn">Find worker</a></center>
    <?php } ?>
   </div>
